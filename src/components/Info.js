  ...
  return (
    <div className="bg-slate-50 dark:bg-[#1d1d1d]">
      <div className="flex justify-center items-center h-[94vh] gap-[10rem]">
        ...
        <img src="https://storage.prompt-hunt.workers.dev/clfmmgx650001m907e27rphnf_2" className="h-[250px] w-[250px] border-4 border-neutral-900 dark:border-neutral-100 bg-no-repeat bg-center bg-cover rounded-full" />
      </div>
    </div>
  )
}
